      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4">
        ...
        >
          <div className="p-6 sm:p-8 pb-6 border-b border-[var(--paper-border)] flex flex-col items-center">
            <h2 className="font-editorial font-bold text-2xl sm:text-3xl text-[var(--ink)] mb-2">Welcome Back</h2>
            <p className="text-[var(--ink-muted)] text-sm font-medium uppercase tracking-widest text-center">Sign in to your account</p>
          </div>

          <div className="p-6 sm:p-8 bg-[var(--paper)]">
            {(error === "CredentialsSignin" || error === "AccessDenied") && (
              <div className="mb-6 p-4 rounded-lg bg-[var(--accent-soft)] border border-[var(--accent)]/30 flex items-start gap-3 text-[var(--accent)]">
                ...
                <p className="text-sm font-medium">Authentication failed. Please verify your credentials or ensure you have access.</p>
              </div>
            )}
            ...
            <p className="mt-8 text-center text-sm font-medium text-[var(--ink-secondary)]">
              ...
              <Link href={`/signup?callbackUrl=${encodeURIComponent(callbackUrl)}`} className="text-[var(--masthead)] hover:underline font-bold">
                Sign up here
              </Link>
            </p>
          </div>
